...
%% Executing Learning
tic
[Wxy_end,Wa_end]=Hamming_Minimisation_Learn_Fingerprint_Parameters(Database.Learning, Wa);
disp(strcat(' Wxy=',num2str(Wxy_end),' Wa=',num2str(Wa_end)));
Time_Learning=toc;

save(strcat(Database_Name,'_Hamming_Minimisation_Learn_FingerPrint_Learned_Weights'));
disp('Learning done');
